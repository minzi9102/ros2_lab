...
class Ur3JointTrajectorySender(Node):
    def __init__(self) -> None:
        super().__init__("ur3_joint_trajectory_sender")
        ...
        self.get_logger().info(
            f"joint_trajectory_sender started. action={self.action_name} topic={self.joint_state_topic}"
        )
