...
def generate_launch_description() -> LaunchDescription:
    return LaunchDescription(
        [
            ...
            DeclareLaunchArgument('tool0_frame', default_value='tool0'),
            ...
            Node(
                ...
                executable='console_calibration_node',
                name='console_tool_calibration',
                output='screen',
                emulate_tty=True,
                parameters=[
                    {
                        'base_frame': LaunchConfiguration('base_frame'),
                        'tool0_frame': LaunchConfiguration('tool0_frame'),
