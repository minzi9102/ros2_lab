...
def generate_launch_description() -> LaunchDescription:
    service_name_arg = DeclareLaunchArgument(
        ...
        description='Named motion service used by the real-robot GUI.',
    )
    human_confirmation_arg = DeclareLaunchArgument(
        'human_confirmation',
        default_value='I_CONFIRM_REAL_ROBOT_MOTION',
        description='Confirmation token required by the real execution gate.',
    )
